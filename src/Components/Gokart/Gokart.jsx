...
const FecondCarouselData = [{ img: img1 }, { img: img2 }, { img: img3 }, { img: img4 }];
...
function Timeline() {
  ...
  const events = [
    { season: "YEAR 2025-2026", details: "Omkar Tigote (CAPTAIN)", Events: "Morphines Motor Sports Series Season 1", image: "/season5.jpg" },
